...
void IRL(){
    while(PORTBbits.RB5==0 && IOCBFbits.IOCBF2==0){
    ...
    while(PORTAbits.RA2==0 && IOCBFbits.IOCBF2==0){
...
void IRR(){
    while(PORTBbits.RB4==0 && IOCBFbits.IOCBF2==0) {
    ...
    while(PORTAbits.RA3==0 && IOCBFbits.IOCBF2==0){
...
void __attribute__((picinterrupt(("")))) echo(){
    ...
    if((IOCBFbits.IOCBF4 == 1 && IOCBNbits.IOCBN4 == 1 && IOCBFbits.IOCBF2==0)||(IOCAFbits.IOCAF3 == 1 && IOCANbits.IOCAN3 == 1 && IOCBFbits.IOCBF2==0)){
        if(IOCBFbits.IOCBF4 == 1 && IOCBNbits.IOCBN4 == 1){
            IOCBNbits.IOCBN4 = 0;
            IOCBFbits.IOCBF4 = 0;
        }
        else if(IOCAFbits.IOCAF3 == 1 && IOCANbits.IOCAN3 == 1){
            IOCANbits.IOCAN3 = 0;
            IOCAFbits.IOCAF3 = 0;
        }
        IRR();
    ...
    if((IOCBFbits.IOCBF5 == 1 && IOCBNbits.IOCBN5 == 1 && IOCBFbits.IOCBF2==0)||(IOCAFbits.IOCAF2 == 1 && IOCANbits.IOCAN2 == 1 && IOCBFbits.IOCBF2==0)){
        if(IOCBFbits.IOCBF5 == 1 && IOCBNbits.IOCBN5 == 1){
            IOCBNbits.IOCBN5 = 0;
            IOCBFbits.IOCBF5 = 0;
        }
        else if(IOCAFbits.IOCAF2 == 1 && IOCANbits.IOCAN2 == 1){
            IOCANbits.IOCAN2 = 0;
            IOCAFbits.IOCAF2 = 0;
        }
        IRL();
